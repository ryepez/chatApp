...
extension ViewController: UIGestureRecognizerDelegate {
    ...
    let tapLocation = gesture.location(in: self.tableView)
        ...
        if let tapIndexPath = self.tableView.indexPathForRow(at: tapLocation) {
            ...
            let cell = tableView.cellForRow(at: tapIndexPath) as! ChatTableViewCell
    ...
    let tapLocation = gesture.location(in: self.tableView)
        ...
        if let tapIndexPath = self.tableView.indexPathForRow(at: tapLocation) {
            ...
            let cell = tableView.cellForRow(at: tapIndexPath) as! ImageTableViewCell
            
            if let DetailVC = self.storyboard?.instantiateViewController(withIdentifier: "BiggerImageViewController") as? BiggerImageViewController {
                
                DetailVC.imageToShow =  cell.profileImageView.image!
    ...
    let tapLocation = gesture.location(in: self.tableView)
        ...
        if let tapIndexPath = self.tableView.indexPathForRow(at: tapLocation) {
            ...
            let cell = tableView.cellForRow(at: tapIndexPath) as! ImageRightTableViewCell
            
            
            if let DetailVC = self.storyboard?.instantiateViewController(withIdentifier: "BiggerImageViewController") as? BiggerImageViewController {
                
                DetailVC.imageToShow = cell.countryImageView.image!
